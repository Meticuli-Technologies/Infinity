...
libraryDependencies += "org.openjfx" % "javafx-base" % "12"
libraryDependencies += "org.openjfx" % "javafx-fxml" % "12"
libraryDependencies += "org.openjfx" % "javafx-graphics" % "12"
libraryDependencies += "org.openjfx" % "javafx-controls" % "12"
